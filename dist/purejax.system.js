System.register([], function (_export) {
  ...
  var rootNode, count, prefix, cacheKey, isArray, XMLHttpRequest, createActiveXObject, typeMap, toString, hasOwnProperty;
  ...
  return {
    setters: [],
    execute: function () {
      rootNode = document.getElementsByTagName('script')[0] || document.head;
      count = 0;
      prefix = '___pj';
      cacheKey = '_';
      isArray = undefined;
      XMLHttpRequest = window.XMLHttpRequest;
      createActiveXObject = window.ActiveXObject;
      typeMap = {
